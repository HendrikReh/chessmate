...
let theme_of_tags tags =
  ...
  then QueensideMajority
  else if
    List.exists downcased ~f:(String.is_substring ~substring:"kingside attack")
  then KingsideAttack
  else if
    List.exists downcased ~f:(String.is_substring ~substring:"central break")
  then CentralBreak
  else Unknown
