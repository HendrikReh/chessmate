...
val key_of_plan :
  ...
  pgn:string ->
  key
(** Derive a deterministic cache key combining plan metadata, game summary and PGN.*)
...
(** Connect to Redis using the given URL; optional namespace and TTL configure key layout/expiry. *)
